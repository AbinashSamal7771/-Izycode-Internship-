...
def create_account():
    ...
    accounts = read_accounts_from_file("accounts.csv")
    ...
    accounts.append({'username': username, 'account': new_account})
    write_account_to_file({'username': username, 'account': new_account}, "accounts.csv")
